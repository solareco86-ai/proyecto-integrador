...
def present_comunicado(comunicado: Comunicado) -> dict[str, Any]:
    """Prepara un comunicado para su presentación pública, sin exponer autor_id."""
    data = asdict(comunicado)
    data.pop("autor_id", None)
    return data
